...
public class MyXeroPage extends Reuse {
	public void Tc8A() throws Exception
	{
		...
		Thread.sleep(4000);
		WebElement startTrial = findElement(By.xpath("//a[@id='simplebutton-1035']"), "startTrial");
		startTrial.click();	
		driver.switchTo().window(getwin[0]);
		String str1="https://go.xero.com/Dashboard/";
	...
	public void Tc8C() throws Exception
	{	
		try
		{
		InitializeDriver("Chrome");
		launchurl("https://login.xero.com/");
		StartReport("MyXeroPage Tc8C");	
		login();
		Wait();
		WebElement Settings = findElement(By.xpath("//div[@class='xrh-appbutton--body']"), "Settings");
		clickButton(Settings, "Settings");	
	...
	public void Tc8F() throws Exception
	{
		InitializeDriver("Chrome");
		launchurl("https://login.xero.com/");
		StartReport("MyXeroPage Tc8F");	
		login();
		Wait();
		try
		{
